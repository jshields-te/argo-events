...
resource-image-te:
	docker build -t gcr.io/te-engg-dev/argoproj/resource-gateway:v0.11 -f ./gateways/core/resource/build/Dockerfile .
	docker push gcr.io/te-engg-dev/argoproj/resource-gateway:v0.11
